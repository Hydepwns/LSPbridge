...
impl LanguageAnalyzer for TypeScriptAnalyzer {
    fn analyze_diagnostic(
        ...
        match diagnostic.code.as_deref() {
            // Property errors
            Some("2339") | Some("2551") => self.analyze_property_error(diagnostic, context),

            // Type errors
            Some("2322") | Some("2345") => self.analyze_type_mismatch(diagnostic, context),

            // Cannot find name
            Some("2304") | Some("2552") => self.analyze_import_error(diagnostic, context),

            // Generic type errors
            Some("2314") => self.analyze_generic_error(diagnostic, context),
