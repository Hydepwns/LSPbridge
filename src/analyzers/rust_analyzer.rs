...
impl LanguageAnalyzer for RustAnalyzer {
    fn analyze_diagnostic(
        ...
        if let Some(code) = &diagnostic.code {
            match code.as_str() {
                ...
                "E0499" | "E0502" | "E0503" | "E0504" | "E0505" => {
                    return self.analyze_borrow_error(diagnostic, context);
                }

                // Lifetime errors
                "E0106" | "E0621" | "E0623" | "E0495" => {
                    return self.analyze_lifetime_error(diagnostic, context);
                }

                // Move errors
                "E0382" | "E0507" | "E0508" | "E0509" => {
                    return self.analyze_move_error(diagnostic, context);
                }

                // Type errors
                "E0308" => {
                    return self.analyze_type_error(diagnostic, context);
                }

                // Trait errors
                "E0277" => {
                    return self.analyze_trait_error(diagnostic, context);
                }
    ...
    fn extract_context_requirements(&self, diagnostic: &Diagnostic) -> ContextRequirements {
        ...
        if matches!(
            ...
            Some("E0499") | Some("E0502") | Some("E0106")
        ) {
            requirements
                .required_symbols
